defmodule MmentumWeb.CoreComponents do
  ...
  def flash_group(assigns) do
    ~H"""
    <.flash id="flash-default" kind={:default} flash={@flash} />
    <.flash id="flash-message" kind={:message} flash={@flash} />
    <.flash id="flash-info" kind={:info} flash={@flash} />
    <.flash id="flash-success" kind={:success} flash={@flash} />
    <.flash id="flash-warning" kind={:warning} flash={@flash} />
